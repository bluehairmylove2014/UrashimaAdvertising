...
function ReportTable({
  ...
  reportData: getAllOfficerReportsResponseType;
      ...
      <div className="flex flex-row gap-4 justify-between mt-4 mb-8 w-full h-8">
        ...
        <div className="flex">
          ...
          <Listbox value={selectedFormReport} onChange={setSelectedFormReport}>
            <div className="">
              <Listbox.Button className="h-full flex flex-row items-center text-[0.65rem] min-w-[10rem] disabled:cursor-not-allowed disabled:bg-zinc-100 bg-cyan-50 border-solid border-[1px] rounded border-zinc-400 ml-3">
                ...
                <Listbox.Options className="absolute z-40 text-[0.65rem] min-w-[10rem] ml-3 rounded bg-white py-1 shadow-lg  focus:outline-none">
                  {formReport.map((form, formIdx) => (
                    <Listbox.Option
                      key={formIdx}
                      className={({ active }) =>
                        `transition-colors w-full text-[0.65rem] py-3 px-2 cursor-default select-none ${
                      ...
                      listData={[
                        ...
                        <span className="font-semibold">
                          <span className="line-clamp-1 font-medium text-xs ">
                            <b>Tên:</b>{' '}
                            <span className="font-normal">{report.name}</span>
                          </span>
                          <span className="line-clamp-1 font-medium text-xs ">
                            <b>Email:</b>{' '}
                            <span className="font-normal">{report.email}</span>
                          </span>
                          <span className="line-clamp-1 font-medium text-xs ">
                            <b>Số điện thoại:</b>{' '}
                            <span className="font-normal">{report.phone}</span>
                          </span>
                          <span className="line-clamp-1 font-medium text-xs">
                            <b>Loại báo cáo:</b>{' '}
