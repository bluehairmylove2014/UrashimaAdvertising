...
function DisplayAdDetail({ adData }: { adData: IAdLocationDetail }) {
  ...
  return (
    <>
      {isMapActive ? (
        <div className="fixed top-0 left-[20vw] w-[80vw] h-screen z-30 overflow-hidden">
          <ViewLocationMap
            initialLatLong={[adData.latitude, adData.longitude]}
          />
          <button
            ...
            <div className="col-span-1 col-start-2 row-start-1">
              ...
              >
                <span className="line-clamp-1 font-medium text-xs ">
                  <b>Kinh Độ:</b>{' '}
                  <span className="text-blue-600">{adData.longitude}</span>
                </span>
                <span className="line-clamp-1 font-medium text-xs ">
                  <b>Vĩ Độ:</b>{' '}
                  <span className="text-blue-600">{adData.latitude}</span>
                </span>
                <span className="text-blue-600 font-medium text-xs">
                  <i className="fi fi-ss-map-marker mr-2"></i>Xem trên bản đồ?
                </span>
              </button>
            </div>
          </div>
                      ...
                      >
                        <TableRow
                          listData={[
                            ...
                            <>
                              {
                                formatDate(new Date(ad.expiredDate))
                                  .dateMonthYear
                              }{' '}
                              <br />
