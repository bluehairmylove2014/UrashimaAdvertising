...
function ReportDetailPoint({ infoPointReport, handleClose, handleBack }
    : {
    ...
    return (
        <div className="h-[100%] w-[25%] bg-white shadow-md min-w-[45vh] fixed overflow-y-scroll scrollbar z-30" style={{ left: 0, top: 0 }}>
            ...
            <div className='mx-3 '>
                ...
                <div className='flex justify-between'>
                    ...
                    <p className='text-rose-600 font-bold text-[0.75rem] '>ĐANG XÉT DUYỆT</p>
                </div>
                <div className='flex mt-1'>
                    <i className="fi fi-br-id-card-clip-alt text-sky-500 text-[0.65rem] mr-1"></i>
                    <p className='text-[0.7rem] text-neutral-600'>Họ và tên:
                ...
                <div className='flex mt-1'>
                    ...
                    <p className=' text-xs text-neutral-600'>Email:
                ...
                <div className='flex mt-1'>
                    ...
                    <p className=' text-[0.7rem] text-neutral-600'>Số điện thoại:
                        <span className='font-semibold '> {infoPointReport.email}</span>
                    </p>
                </div>
                ...
                <div className='flex mt-1'>
                    ...
                    <p className=' text-[0.7rem] text-neutral-600'>Hình thức báo cáo:
                        <span className='font-semibold '> {infoPointReport.reportType}</span>
                    </p>
                </div>
                ...
                {Array.isArray(infoPointReport.images) ? infoPointReport.images.length ?
                    <>
                        <div className='flex mt-2'>
                            <i className="fi fi-br-picture text-sky-500 text-[0.65rem] mr-1"></i>
                            <p className=' text-[0.7rem] text-neutral-600'>Hình ảnh minh chứng:</p>
                        </div>

                        <Carousel showStatus={false} showThumbs={false}>
                            {infoPointReport.images.map((data, index) => (
                                <div className="w-[100%] h-[30vh] rounded" key={`carousel@${index}`}>
                                    <CustomImage
                ...
                {infoPointReport.reportData ?
                    <>
                        <div className='flex mt-2'>
                            ...
                            <p className='text-[0.7rem] text-neutral-600'>Địa chỉ:
                                <span className='font-semibold '> {infoPointReport.reportData.address}</span>
                            </p>
                        </div>
                        <div className='flex mt-1'>
                            <i className="fi fi-sr-settings text-sky-500 text-[0.65rem] mr-1"></i>
                            <p className='text-[0.7rem] text-neutral-600'>Hình thức:
                                <span className='font-semibold '> {infoPointReport.reportData.adsForm}</span>
                            </p>
                        </div>
                        <div className='flex mt-1'>
                            <i className="fi fi-sr-layers text-sky-500 text-[0.65rem] mr-1"></i>
                            <p className='text-[0.7rem] text-neutral-600'>Loại vị trí:
                                <span className='font-semibold '> {infoPointReport.reportData.locationType}</span>
                            </p>
                        </div>
                        <div className='flex my-1'>
                            {infoPointReport.reportData.planned ?
                                <p className='font-bold text-medium ỉtalic text-green-600'>ĐÃ QUY HOẠCH</p>
                                :
                                <p className='font-bold text-medium text-rose-600'>CHƯA QUY HOẠCH</p>}
                        </div>
                        <Carousel showStatus={false} showThumbs={false}>
                    ...
                    <>
                        <div className='flex mt-2'>
                            ...
                            <p className='text-[0.7rem] text-neutral-600'>Vĩ độ:
                                <span className='font-semibold '> {infoPointReport.latitude}</span>
                            </p>
                        </div>
                        <div className='flex mt-1'>
                            <i className="fi fi-ss-star text-sky-500 text-[0.65rem] mr-1"></i>
                            <p className='text-[0.7rem] text-neutral-600'>Kinh độ:
                                <span className='font-semibold '> {infoPointReport.longitude}</span>
                            </p>
                        </div>
