...
function Announcement({ handleClose }: { handleClose: () => void }) {
  ...
  const reportResponse = [
    {
      time: '1 days ago',
      content:
        'In this example, the overflow-hidden class is used to hide any content that overflows its container. The line-clamp-3 class is a utility class provided by Tailwind CSS to set the -webkit-line-clamp property to limit the number of lines to 3.',
    },
    {
      time: '1 days ago',
      content:
  ...
  return (
    <div
      className="shadow-md min-w-[40vh]  w-[22%] fixed z-40 rounded mr-2 mt-1"
      style={{ right: 0 }}
    >
      <section className=" relative py-2 bg-neutral-100 rounded">
            ...
            <div key={index}>
              <div className="py-1 px-2 font-medium text-[0.55rem] bg-white text-gray-500 hover:text-white hover:bg-blue-800 w-[100%]">
                ...
                <div className="flex mt-1 flex-row justify-between items-center">
                  <button
                    className="text-[0.5rem] text-white bg-blue-600 rounded px-1"
                    disabled
                  >
                  ...
                  <div className="flex">
                    ...
                    <p className="text-right text-[0.55rem] font-semibold">
                      {item.time}
                    </p>
                  </div>
                </div>
        ...
        <hr />
        <button
          className="text-blue-700 hover:text-blue-800 hover:underline mt-1 text-[0.65rem] font-semibold text-center w-full"
